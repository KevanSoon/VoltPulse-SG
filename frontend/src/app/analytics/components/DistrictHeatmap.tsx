  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-80 bg-gray-900/50 rounded-lg overflow-hidden">
        ...
        {/* Legend */}
        <div className="absolute bottom-3 left-3 bg-gray-900/90 rounded-lg p-3 backdrop-blur-sm">
        ...
        {selectedDistrict && (
          <div className="absolute top-3 right-3 bg-gray-900/90 rounded-lg p-4 backdrop-blur-sm max-w-xs">
            ...
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className={`font-medium ${
                  selectedDistrict.intensity > 0.66 ? "text-red-400" :
                  selectedDistrict.intensity > 0.33 ? "text-yellow-400" : "text-green-400"
                }`}>
